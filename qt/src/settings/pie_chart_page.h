...
#ifndef PIE_CHART_PAGE_H
#define PIE_CHART_PAGE_H
...
class PieChartPage : public SettingsPage
{
	Q_OBJECT
public:
	PieChartPage(QSettings& settings, QWidget* parent = 0);
...
protected:
	...
	QComboBox*		m_pSelectedSegmentsType;
};

#endif // PIE_CHART_PAGE_H
